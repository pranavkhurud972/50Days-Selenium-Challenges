...
public class _15_FillFormUsingRandomUserAPI {
    ...
    public void fetchVinAndInputTest() throws IOException {
        ...
        driver.findElement(By.className("file_upload")).sendKeys(System.getProperty("user.dir") +"/src/test/resources/TestFile.txt");
